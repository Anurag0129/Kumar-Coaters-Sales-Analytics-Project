...
## 🤖 Chatbot
- Built using **Dialogflow** to handle client FAQs (pricing, service timelines, coating services).
- [View Chatbot Project](./chatbot)

## 🏭 AI Parts Sorting
- Built using **Teachable Machine** to classify and sort parts into **Sections A–G**.
- [View Parts Sorting Model](./ai_parts_sorting)
